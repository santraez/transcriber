        ...
        <>
          ...
          {props.transcriber.progressItems.length > 0 && (
            <div className="fixed bottom-0 right-0 left-0 w-full">
              <ModelLoader items={props.transcriber.progressItems} />
            </div>
          )}
        </>
      )}
      ...
      content={
        <>
          <LangSelect
            ...
            onValueChange={(value) => {
              props.transcriber.setModel(value);
            }}
          />
          ...
          {props.transcriber.multilingual && (
            <>
              <LangSelect
                ...
                onValueChange={(value) => {
                  props.transcriber.setLanguage(value);
                }}
              />
              <LangSelect
                items={{ transcribe: "transcribe", translate: "translate" }}
                placeholder="Select the task to perform."
                defaultValue={props.transcriber.subtask}
                onValueChange={(value) => {
                  props.transcriber.setSubtask(value);
                }}
              />
            </>
          )}
